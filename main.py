...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.label_theme = CTkOptionMenu(self.menu, values=['Light', 'Dark'], command=self.change_theme, height=50)
        self.label_theme.pack(side='bottom', pady=self.winfo_height() * 0.9)
